...
public class Knapsack4 {
    ...
    public Knapsack4(int[] weights, int[] profits, int capacity, int DFSLEVELS) {
    ...
    public static class Test1 {
        public static void main(String[] args) {
            try {
                ...
                System.out.println();
                Knapsack4 ks = new Knapsack4(w, p, capacity, dfslevels);
    ...
    public static class Test3 {
        public static void main(String[] args) {
            try {
                if (args.length < 2) {
                    System.out.println("usage: java Knapsack4 length dfslevels");
                    System.exit(0);
                }
                ...
                long starttime = System.currentTimeMillis();
                Knapsack4 ks = new Knapsack4(w, p, capacity, DFSLVLS);
                ks.getProfit();
                System.out.println("Knapsack4\t" + num + "\t" + DFSLVLS + "\t"
                        + (System.currentTimeMillis() - starttime));
            } catch (Exception exc) {
                System.out.println(exc);
            }
    ...
    class Search implements Runnable {
        ...
        void dfs(int i, int rw, int p) {
            if (i >= item.length) {
                if (p > bestProfit) {
                    synchronized (Knapsack4.this) {
                        if (p > bestProfit) {
                            bestProfit = p;
                            Knapsack4.this.selected = (BitSet) b.clone();
