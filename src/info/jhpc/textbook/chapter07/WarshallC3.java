...
class WarshallC3 {
   ...
   public boolean[][] closure(boolean[][] a) {
      ...
      for (i = 0; i < a.length; i++) {
         rq.run(new Row((boolean[]) a[i].clone(), i, kthRows, done, rq));
      }
      boolean[][] result = null;
      try {
   ...
   public static class Test1 {
      public static void main(String[] args) {
         ...
         WarshallC3 w = new WarshallC3(nt);
         for (i = 0; i < N; i++)
            a[i][(i + 1) % N] = true;
         show(a);
         System.out.println();
   ...
   public static class TestTime2 {
      public static void main(String[] args) {
         if (args.length < 2) {
            System.out.println("usage: java WarshallC3$TestTime2 N nt");
            System.exit(0);
         }
         ...
         a = w.closure(a);
         System.out.println("WarshallC3\t" + N + "\t" + nt + "\t"
